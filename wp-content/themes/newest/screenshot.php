...
<html class="no-js" lang="zxx">
    ...
    <body>
                            ...
                            <div class="main-menu f-right mr-15 d-none d-xl-block">
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li class="active"><a href="screenshot.html">Screenshots</a></li>
        ...
        <main>
            ...
            <section class="screenshot-area pt-110 pb-160 background-image-style" data-background="img/bg/theme-bg-01.jpg">
                <div class="container">
