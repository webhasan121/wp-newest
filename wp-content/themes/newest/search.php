                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="page-title text-center">
                                <h2><?php printf(esc_html__('Search Results for : %s','newest'), '<span>' . esc_html__(get_search_query()) . '</span>');?></h2>
                                <ul class="breadcrumb-menu">
                                    <li class="breadcrumb-items"><a href="" title="Home">Home</a></li>
                                    <li class="active"><?php echo esc_html__('Search page','newest')?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
